...
public class AppointmentsDao {
	...
	public static int insertAppointment(Appointment newapp) {
		String insertquery = "insert into appointment (ID,APPDATE,DOCTOR_ID,PATIENT_NAME,FEES_COLLECTED) values (?,?,?,?,?)";
		Connection con = null;
		int rows = 0;
//		int rows ;
	...
	public static int updateAppointment(Appointment newapp) {
		String updatequery = "update appointments set APPDATE=?,DOCTOR_ID=?,PATIENT_NAME=?,FEES_COLLECTED=? where ID=?";
		Connection con = null;
		int rows = 0;
		PreparedStatement ps = null;
		try {
	...
	public static int updateAppointmentName(int id, String appname) {
		String updatequery = "update appointment set PATIENT_NAME=? where id=?";
		Connection con = null;
		int rows = 0;
		PreparedStatement ps = null;
		try {
	...
	public static int updateAppointmentFees(int id, float fees) {
		String updatequery = "update appointment set fees_collected=? where id=?";
		Connection con = null;
		int rows = 0;
		PreparedStatement ps = null;
		try {
...
//			ps.executeUpdate();
	...
	public static Appointment getAppointmentById(int id) {
		...
		String selectquery = "select ID,APPDATE,DOCTOR_ID,PATIENT_NAME,FEES_COLLECTED from appointment where ID=?";
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
	...
	public static List<Appointment> getAllAppointment() {
		...
		Appointment app = null;
		String selectquery = "select ID,APPDATE,DOCTOR_ID,PATIENT_NAME,FEES_COLLECTED from appointment ";
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		try {
