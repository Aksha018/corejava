...
public class TestRunnableWorker {
	...
	public static void main(String[] args) 
	{
		...
		multiThreadSynchronizedOnSameObject();
	}
	...
	System.out.println("T1 State "+t1.getState());
			System.out.println("T2 State "+t2.getState());
			  	...
			  	public static void multiThreadSynchronizedOnSameObject()
			  	{
			  		try
			  		{
			  			Thread t=Thread.currentThread();
						...
						Thread t3=new Thread(firstWorker);
						 ...
						 t2.start();
						 t3.start();
						 System.out.println("From Main End "+firstWorker.amount);
					 }catch(Exception e)
					 {
						System.out.println("Error!!!"+e.getMessage());
					 }		
